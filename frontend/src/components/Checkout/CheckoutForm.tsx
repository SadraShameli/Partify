...
import { IContactInformation, IDeliveryMethod, IShippingInformation, DeliveryMethods } from './CheckoutTypes';
...
interface ICheckoutForm extends IContactInformation, IShippingInformation {}
...
export default function CheckoutForm() {
    ...
    return (
        <form className='md:grid flex flex-col-reverse grid-cols-2 gap-20 mt-hero' onSubmit={handleSubmit(onSubmit)}>
            <div className='grid col-span-1 divide-y gap-10'>
                <div>
