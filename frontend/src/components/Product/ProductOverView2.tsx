                ...
                <div className='grid grid-cols-3 gap-5 h-[36rem] mt-5'>
                    ...
                    <div className='grid gap-5'>
                        {product.variants[0].images[1] && (
                            <div className='relative'>
                                <Image className='img object-top' src={product.variants[0].images[1]} alt={product.title} fill />
                            </div>
                        )}

                        {product.variants[0].images[2] && (
                            <div className='relative'>
                                <Image className='img object-bottom' src={product.variants[0].images[2]} alt={product.title} fill />
                            </div>
                        )}
                    </div>
                    ...
                    {product.variants[0].images[3] && (
                        <div className='relative'>
                            <Image className='img' src={product.variants[0].images[3]} alt={product.title} fill />
                        </div>
                    )}
                </div>
