        ...
        <div className='flex justify-between'>
            <div className='flex w-full gap-5'>
                <div className='h-36 relative w-24'>
                    <Image src={product.variants[0].images[0]} alt={product.name} className='img' priority fill />
                </div>
                ...
                <div className='flex justify-between flex-1 gap-5 py-2'>
                    <div className='flex flex-col justify-between'>
                        ...
                        <p className='text-sm font-medium text-gray-900'>{`${product.currency}${product.variants[0].price}`}</p>
                    </div>
                    ...
                    <button className='self-start' type='button' onClick={() => onRemove()}>
                        <svg className='fill-none w-6 h-6' viewBox='0 0 24 24'>
                            ...
                            />
                            <path className='stroke-slate-500 stroke-2' d='M10 11V16' />
                            <path className='stroke-slate-500 stroke-2' d='M14 11V16' />
                        </svg>
                    </button>
                </div>
            </div>
