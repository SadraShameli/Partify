function ActiveStar(key: number) {
    return (
        <svg key={key} aria-hidden='true' className='h-5 w-5 fill-current text-yellow-400' viewBox='0 0 20 20'>
...
function DisabledStar(key: number) {
    return (
        <svg key={key} aria-hidden='true' className='h-5 w-5 fill-current text-gray-300 dark:text-gray-500' viewBox='0 0 20 20'>
