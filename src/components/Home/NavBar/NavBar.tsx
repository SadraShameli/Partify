            ...
            <div className='fixed z-[9999] w-full bg-[rgba(255,255,255,0.7)] fill-none stroke-current py-3 text-sm saturate-[200%] backdrop-blur-[20px] dark:bg-[rgba(0,0,0,0.8)]'>
                <div className='container flex items-center justify-between'>
                    <div className='flex items-center'>
                        <Link className='pr-5 sm:border-r' type='button' title='Home' href='/'>
                        ...
                        <div className='hidden gap-5 pl-5 sm:flex'>
                            <a>Men</a>
                            <a>Women</a>
                            <a>Children</a>
                        </div>
                    ...
                    <div className='flex items-center gap-5'>
                        <div className='flex gap-5 border-r pr-5'>
                        ...
                        {/* <Link type='button' title='Login' href={Router.signin}>
                        ...
                        {/* <Link type='button' title='Shopping bag' href={Router.checkout}>
