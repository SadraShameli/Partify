            ...
            <div className='hidden gap-10 pr-16 md:grid'>
                ...
                <div className='pt-10'>
                    ...
                    <div className='grid gap-5 fill-current children:flex children:items-center children:gap-4 children:text-sm'>
                        ...
                        <button className='hover:text-primary' type='button'>
                            <svg className='h6 w-6' viewBox='0 0 16 16'>
                        ...
                        <button className='hover:text-primary' type='button'>
                            <svg className='h6 w-6' viewBox='0 0 1024 1024'>
                ...
                <div className='border-t pt-10'>
                    ...
                    <div className='grid gap-5 fill-current children:flex children:items-center children:gap-4 children:text-sm'>
                        ...
                        <button className='hover:text-primary' type='button' onClick={() => signOut({ callbackUrl: '/' })}>
                            <SignOutIcon className='stroke-current' />
                            Sign out
                        </button>
                    </div>
                </div>
