...
export default function NavigationBar() {
    return (
        <>
            <nav className='backdrop-blur-[20px] saturate-[180%] bg-[rgba(0,0,0,0.8)] fixed w-full z-[9999]'>
                <div className='container flex items-center justify-between py-3 text-xs font-light text-[#f5f5f7] fill-none stroke-[#f5f5f7]'>
                    ...
                    <button type='button' title='Theme selector'>
                        <svg viewBox='0 0 24 24' className='w-6 h-6 hidden dark:inline'>
                        ...
                        <svg viewBox='0 0 24 24' className='w-6 h-6 dark:hidden'>
